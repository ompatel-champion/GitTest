<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Notes.aspx.cs" Inherits="Crm6.Reporting.KPIs.DetailViews.Notes" %>
                        ...
                        <ItemTemplate>
                            <div class=" PB0">
                                <div class="media-body">
                                    <strong class="MB5"><%#  Eval("NoteContent")%></strong>
                                    <div class="clearfix MB5"></div>
                                    <small class="FontSize10  MB5 text-navy">Created on  <%# Convert.ToDateTime( Eval("ActivityDate").ToString()).ToString("dd MMM, yyyy @ HH:mm")   %>  
                                    </small>
