<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ImportCompaniesContacts.aspx.cs" Inherits="Crm6.Import.ImportCompaniesContacts" %>
...
<head runat="server">
    ...
    <title>Import HKG Company Excel File</title>
                ...
                <div class="  wrapper border-bottom white-bg page-heading">
                    <div class="col-sm-10">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <strong class="language-entry">Import Company/Contact Excel File</strong>
                            </li>
                        </ol>
                    </div>
                            ...
                            <div>
                                ...
                                <div class="text-center form-group m-t-md">
                                    ...
                                    <a id="btnUploadHkgExcel" class="btn btn-primary btn-sm" href="javascript:void(0)">
                                        ...
                                        <span class="language-entry">Upload Company/Contact Excel File</span>
                                    </a>
...
<script src="importcompaniescontacts.js?q=" <%= Guid.NewGuid().ToString() %>></script>
