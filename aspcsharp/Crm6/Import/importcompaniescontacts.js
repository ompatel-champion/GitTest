...
var FileUpload = function () {
    ...
    this.Init = function () {
        ...
        $iptHkgExcel.ajaxfileupload({
            action: baseUploadUrl + "ref=" + $("#lblGuid").text() + "&folder=uploadHkgCompanyData&delete=true",
    ...
    this.BindFile = function (uploadedFile) {
        ...
        $("#btnProcessFile").unbind("click").click(function () { 
            ...
            $.ajax({
                type: "GET",
                url: "/api/import/CompanyContactImport/?blobReference=" + uploadedFile.BlobReference + "&containerReference=" + uploadedFile.ContainerReference + "&subscriberId=" + subscriberId + "&userId=" + processUserId,
                data: {},
